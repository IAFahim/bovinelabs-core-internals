// Run: cat snippets/other/ReferenceData.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/ReferenceData.md claims
...
// --- ReferenceData ---
var v0 = findType("BovineLabs.Core.ReferenceData");
if (v0 != null)
{
    ...
    check("ReferenceData exists", true);
...
{
    sb.AppendLine("ReferenceData: TYPE NOT FOUND");
    check("ReferenceData exists", false);
}

// --- ReferenceHeader ---
var v1 = findType("BovineLabs.Core.ReferenceHeader");
if (v1 != null)
{
    var kind = v1.IsValueType ? "struct" : (v1.IsInterface ? "interface" : (v1.IsAbstract && v1.IsSealed ? "static class" : "class"));
    sb.AppendLine("ReferenceHeader");
    sb.AppendLine("  Kind: " + kind);
    try { sb.AppendLine("  Size: " + System.Runtime.InteropServices.Marshal.SizeOf(v1) + " bytes"); } catch {}
    check("ReferenceHeader exists", true);
    sb.AppendLine("  Interfaces:");
...
{
    sb.AppendLine("ReferenceHeader: TYPE NOT FOUND");
    check("ReferenceHeader exists", false);
}
