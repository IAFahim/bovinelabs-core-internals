// Run: cat snippets/other/Pin.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/Pin.md claims
...
// --- Editor ---
var v0 = findType("BovineLabs.Core.Extensions.Editor");
if (v0 != null)
{
...
// --- to ---
var v1 = findType("BovineLabs.Core.to");
if (v1 != null)
{
...
// --- would ---
var v2 = findType("BovineLabs.Core.would");
if (v2 != null)
{
...
{
    sb.AppendLine("would: TYPE NOT FOUND");
    check("would exists", false);
}
