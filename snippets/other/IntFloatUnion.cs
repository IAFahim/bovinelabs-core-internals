// Run: cat snippets/other/IntFloatUnion.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/IntFloatUnion.md claims
...
// --- float ---
var v1 = findType("BovineLabs.Core.float");
if (v1 != null)
{
...
{
    sb.AppendLine("float: TYPE NOT FOUND");
    check("float exists", false);
}
