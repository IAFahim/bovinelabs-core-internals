// Run: cat snippets/other/MainToolbarPresetPostProcessor.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- CodeGen ---
var v0 = findType("BovineLabs.Core.Extensions.CodeGen");
if (v0 != null)
{
...
{
    sb.AppendLine("CodeGen: TYPE NOT FOUND");
    check("CodeGen exists", false);
}
