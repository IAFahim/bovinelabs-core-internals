// Run: cat snippets/other/CoreEditorPreferencesProvider.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "BovineLabs.Core.Editor.EditorPreferences,System,System.Linq,System.Reflection"
// Verifies: docs/CoreEditorPreferencesProvider.md claims
...
sb.AppendLine("EditorPreferences");
try
{
    var t0 = typeof(BovineLabs.Core.Editor.EditorPreferences);
    ...
    check("EditorPreferences exists", true);
...
catch (System.Exception) { sb.AppendLine("  TYPE NOT FOUND"); check("EditorPreferences exists", false); }
