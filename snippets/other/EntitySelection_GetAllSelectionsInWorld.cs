// Run: cat snippets/other/EntitySelection_GetAllSelectionsInWorld.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "BovineLabs.Core.Editor.Internal,System,System.Linq,System.Reflection,Unity.Collections,Unity.Entities"
// Verifies: docs/EntitySelection_GetAllSelectionsInWorld.md claims
...
try
{
    var t0 = typeof(BovineLabs.Core.Editor.Internal);
...
catch (System.Exception) { sb.AppendLine("  TYPE NOT FOUND"); check("Internal exists", false); }
