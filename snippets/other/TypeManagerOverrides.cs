// Run: cat snippets/other/TypeManagerOverrides.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/TypeManagerOverrides.md claims
...
{
    sb.AppendLine("TypeManagerOverrides: TYPE NOT FOUND");
    check("TypeManagerOverrides exists", false);
}
