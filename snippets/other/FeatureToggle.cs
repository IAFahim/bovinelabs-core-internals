// Run: cat snippets/other/FeatureToggle.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- Welcome ---
var v0 = findType("BovineLabs.Core.Editor.Welcome");
if (v0 != null)
{
...
{
    sb.AppendLine("Welcome: TYPE NOT FOUND");
    check("Welcome exists", false);
}
