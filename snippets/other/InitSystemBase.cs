// Run: cat snippets/other/InitSystemBase.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/InitSystemBase.md claims
...
// --- for ---
var v0 = findType("BovineLabs.Core.for");
if (v0 != null)
{
...
{
    sb.AppendLine("for: TYPE NOT FOUND");
    check("for exists", false);
}

// --- overrides ---
var v1 = findType("BovineLabs.Core.overrides");
if (v1 != null)
{
...
{
    sb.AppendLine("overrides: TYPE NOT FOUND");
    check("overrides exists", false);
}

// --- implements ---
var v2 = findType("BovineLabs.Core.implements");
if (v2 != null)
{
...
{
    sb.AppendLine("implements: TYPE NOT FOUND");
    check("implements exists", false);
}
