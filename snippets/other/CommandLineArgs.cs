// Run: cat snippets/other/CommandLineArgs.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/CommandLineArgs.md claims
...
// --- load ---
var v0 = findType("BovineLabs.Core.load");
if (v0 != null)
{
...
{
    sb.AppendLine("load: TYPE NOT FOUND");
    check("load exists", false);
}
