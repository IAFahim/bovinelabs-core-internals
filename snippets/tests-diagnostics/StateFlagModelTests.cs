// Run: cat snippets/tests-diagnostics/StateFlagModelTests.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "BovineLabs.Core.Tests.States,System,System.Linq,System.Reflection"
// Verifies: docs/StateFlagModelTests.md claims
...
try
{
    var t0 = typeof(BovineLabs.Core.Tests.States);
...
catch (System.Exception) { sb.AppendLine("  TYPE NOT FOUND"); check("States exists", false); }
