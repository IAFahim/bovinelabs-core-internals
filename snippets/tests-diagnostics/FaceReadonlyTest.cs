// Run: cat snippets/tests-diagnostics/FaceReadonlyTest.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/FaceReadonlyTest.md claims
...
// --- Facet ---
var v0 = findType("BovineLabs.Core.Tests.Facet");
if (v0 != null)
{
...
{
    sb.AppendLine("Facet: TYPE NOT FOUND");
    check("Facet exists", false);
}
