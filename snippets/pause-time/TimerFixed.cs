// Run: cat snippets/pause-time/TimerFixed.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/TimerFixed.md claims
...
// --- at ---
var v0 = findType("BovineLabs.Core.at");
if (v0 != null)
{
...
{
    sb.AppendLine("at: TYPE NOT FOUND");
    check("at exists", false);
}
