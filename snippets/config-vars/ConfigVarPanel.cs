// Run: cat snippets/config-vars/ConfigVarPanel.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/ConfigVarPanel.md claims
...
{
    sb.AppendLine("ConfigVars: TYPE NOT FOUND");
    check("ConfigVars exists", false);
}
