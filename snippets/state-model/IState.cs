// Run: cat snippets/state-model/IState.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/IState.md claims
...
// --- that ---
var v0 = findType("BovineLabs.Core.that");
if (v0 != null)
{
...
{
    sb.AppendLine("that: TYPE NOT FOUND");
    check("that exists", false);
}

// --- GameState ---
var v1 = findType("BovineLabs.Core.GameState");
if (v1 != null)
{
...
{
    sb.AppendLine("GameState: TYPE NOT FOUND");
    check("GameState exists", false);
}

// --- from ---
var v2 = findType("BovineLabs.Core.from");
if (v2 != null)
{
...
{
    sb.AppendLine("from: TYPE NOT FOUND");
    check("from exists", false);
}
