// Run: cat snippets/state-model/StateFlagModelTests.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- States ---
var v0 = findType("BovineLabs.Core.Tests.States");
if (v0 != null)
{
...
{
    sb.AppendLine("States: TYPE NOT FOUND");
    check("States exists", false);
}
