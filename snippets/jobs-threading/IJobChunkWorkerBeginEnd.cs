// Run: cat snippets/jobs-threading/IJobChunkWorkerBeginEnd.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/IJobChunkWorkerBeginEnd.md claims
...
// --- default ---
var v0 = findType("BovineLabs.Core.default");
if (v0 != null)
{
...
{
    sb.AppendLine("default: TYPE NOT FOUND");
    check("default exists", false);
}
