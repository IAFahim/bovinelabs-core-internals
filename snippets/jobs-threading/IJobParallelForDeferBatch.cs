// Run: cat snippets/jobs-threading/IJobParallelForDeferBatch.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/IJobParallelForDeferBatch.md claims
...
// --- calls ---
var v0 = findType("BovineLabs.Core.calls");
if (v0 != null)
{
...
{
    sb.AppendLine("calls: TYPE NOT FOUND");
