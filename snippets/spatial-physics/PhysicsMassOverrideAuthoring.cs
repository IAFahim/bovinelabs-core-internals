// Run: cat snippets/spatial-physics/PhysicsMassOverrideAuthoring.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "BovineLabs.Core.Authoring.Entities,System,System.Linq,System.Reflection"
// Verifies: docs/PhysicsMassOverrideAuthoring.md claims
...
try
{
    var t0 = typeof(BovineLabs.Core.Authoring.Entities);
...
catch (System.Exception) { sb.AppendLine("  TYPE NOT FOUND"); check("Entities exists", false); }
