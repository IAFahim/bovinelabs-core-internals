// Run: cat snippets/extension-methods/RefRWExtensions_Create.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/RefRWExtensions_Create.md claims
...
{
    sb.AppendLine("RefRWExtensions: TYPE NOT FOUND");
    check("RefRWExtensions exists", false);
}
