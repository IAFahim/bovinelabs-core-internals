// Run: cat snippets/extension-methods/IJobParallelForDeferExtensions.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/IJobParallelForDeferExtensions.md claims
...
// --- cast ---
var v1 = findType("BovineLabs.Core.cast");
if (v1 != null)
{
...
{
    sb.AppendLine("cast: TYPE NOT FOUND");
    check("cast exists", false);
}
