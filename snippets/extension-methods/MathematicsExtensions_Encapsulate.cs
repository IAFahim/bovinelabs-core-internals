// Run: cat snippets/extension-methods/MathematicsExtensions_Encapsulate.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/MathematicsExtensions_Encapsulate.md claims
...
// --- with ---
var v0 = findType("BovineLabs.Core.with");
if (v0 != null)
{
...
{
    sb.AppendLine("with: TYPE NOT FOUND");
    check("with exists", false);
}
