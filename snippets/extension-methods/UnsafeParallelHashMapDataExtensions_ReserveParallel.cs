// Run: cat snippets/extension-methods/UnsafeParallelHashMapDataExtensions_ReserveParallel.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/UnsafeParallelHashMapDataExtensions_ReserveParallel.md claims
...
// --- UnsafeParallelHashMapDataExtensions ---
var v0 = findType("BovineLabs.Core.UnsafeParallelHashMapDataExtensions");
if (v0 != null)
{
    var kind = v0.IsValueType ? "struct" : (v0.IsInterface ? "interface" : (v0.IsAbstract && v0.IsSealed ? "static class" : "class"));
    sb.AppendLine("UnsafeParallelHashMapDataExtensions");
    sb.AppendLine("  Kind: " + kind);
    try { sb.AppendLine("  Size: " + System.Runtime.InteropServices.Marshal.SizeOf(v0) + " bytes"); } catch {}
    check("UnsafeParallelHashMapDataExtensions exists", true);
...
{
    sb.AppendLine("UnsafeParallelHashMapDataExtensions: TYPE NOT FOUND");
    check("UnsafeParallelHashMapDataExtensions exists", false);
}
