// Run: cat snippets/authoring-baking/CloneTransformAuthoring.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/CloneTransformAuthoring.md claims
...
// --- Clone ---
var v0 = findType("BovineLabs.Core.Authoring.Clone");
if (v0 != null)
{
...
{
    sb.AppendLine("Clone: TYPE NOT FOUND");
    check("Clone exists", false);
}
