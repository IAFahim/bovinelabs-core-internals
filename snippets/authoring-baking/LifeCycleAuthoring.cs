// Run: cat snippets/authoring-baking/LifeCycleAuthoring.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- LifeCycle ---
var v0 = findType("BovineLabs.Core.Authoring.LifeCycle");
if (v0 != null)
{
...
{
    sb.AppendLine("LifeCycle: TYPE NOT FOUND");
    check("LifeCycle exists", false);
}
