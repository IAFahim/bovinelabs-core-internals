// Run: cat snippets/authoring-baking/ObjectDefinitionAuthoring.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/ObjectDefinitionAuthoring.md claims
...
{
    sb.AppendLine("ObjectManagement: TYPE NOT FOUND");
    check("ObjectManagement exists", false);
}

// --- Authoring ---
var v1 = findType("BovineLabs.Core.Extensions.Authoring");
if (v1 != null)
{
...
{
    sb.AppendLine("Authoring: TYPE NOT FOUND");
    check("Authoring exists", false);
}
