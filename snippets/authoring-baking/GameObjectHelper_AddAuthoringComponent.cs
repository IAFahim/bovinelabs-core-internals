// Run: cat snippets/authoring-baking/GameObjectHelper_AddAuthoringComponent.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- Helpers ---
var v0 = findType("BovineLabs.Core.Editor.Helpers");
if (v0 != null)
{
...
{
    sb.AppendLine("Helpers: TYPE NOT FOUND");
    check("Helpers exists", false);
}
