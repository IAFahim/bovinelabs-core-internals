// Run: cat snippets/authoring-baking/RemovePhysicsVelocityAuthoring.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/RemovePhysicsVelocityAuthoring.md claims
...
// --- Entities ---
var v0 = findType("BovineLabs.Core.Authoring.Entities");
if (v0 != null)
{
...
{
    sb.AppendLine("Entities: TYPE NOT FOUND");
    check("Entities exists", false);
}
