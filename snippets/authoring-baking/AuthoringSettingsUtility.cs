// Run: cat snippets/authoring-baking/AuthoringSettingsUtility.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- Settings ---
var v0 = findType("BovineLabs.Core.Authoring.Settings");
if (v0 != null)
{
...
{
    sb.AppendLine("Settings: TYPE NOT FOUND");
    check("Settings exists", false);
}
