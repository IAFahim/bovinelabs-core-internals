// Run: cat snippets/life-cycle/GameObjectHelper_AddAuthoringComponent.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "BovineLabs.Core.Editor.Helpers,System,System.Linq,System.Reflection"
// Verifies: docs/GameObjectHelper_AddAuthoringComponent.md claims
...
try
{
    var t0 = typeof(BovineLabs.Core.Editor.Helpers);
...
catch (System.Exception) { sb.AppendLine("  TYPE NOT FOUND"); check("Helpers exists", false); }
