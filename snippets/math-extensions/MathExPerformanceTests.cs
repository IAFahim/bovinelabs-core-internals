// Run: cat snippets/math-extensions/MathExPerformanceTests.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/MathExPerformanceTests.md claims
...
// --- Utility ---
var v0 = findType("BovineLabs.Core.PerformanceTests.Utility");
if (v0 != null)
{
...
{
    sb.AppendLine("Utility: TYPE NOT FOUND");
    check("Utility exists", false);
}
