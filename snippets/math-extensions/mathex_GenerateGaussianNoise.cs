// Run: cat snippets/math-extensions/mathex_GenerateGaussianNoise.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/mathex_GenerateGaussianNoise.md claims
...
// --- also ---
var v0 = findType("BovineLabs.Core.also");
if (v0 != null)
{
...
{
    sb.AppendLine("NoiseJob: TYPE NOT FOUND");
    check("NoiseJob exists", false);
}
