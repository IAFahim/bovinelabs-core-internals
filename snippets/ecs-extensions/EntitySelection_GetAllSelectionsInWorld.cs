// Run: cat snippets/ecs-extensions/EntitySelection_GetAllSelectionsInWorld.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- Internal ---
var v0 = findType("BovineLabs.Core.Editor.Internal");
if (v0 != null)
{
...
{
    sb.AppendLine("Internal: TYPE NOT FOUND");
    check("Internal exists", false);
}
