// Run: cat snippets/ecs-extensions/UnsafeUntypedDynamicBufferAccessor.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/UnsafeUntypedDynamicBufferAccessor.md claims
...
var v0 = findType("BovineLabs.Core.UnsafeUntypedDynamicBufferAccessor");
if (v0 != null)
{
    ...
    check("UnsafeUntypedDynamicBufferAccessor exists", true);
...
{
    sb.AppendLine("UnsafeUntypedDynamicBufferAccessor: TYPE NOT FOUND");
    check("UnsafeUntypedDynamicBufferAccessor exists", false);
}
