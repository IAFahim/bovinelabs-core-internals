// Run: cat snippets/source-generators/CodeBuilder.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/CodeBuilder.md claims
...
{
    sb.AppendLine("CodeBuilder: TYPE NOT FOUND");
    check("CodeBuilder exists", false);
}
