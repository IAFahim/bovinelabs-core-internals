// Run: cat snippets/source-generators/ExpressionBlockBuilder.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/ExpressionBlockBuilder.md claims
...
{
    sb.AppendLine("ExpressionBlockBuilder: TYPE NOT FOUND");
    check("ExpressionBlockBuilder exists", false);
}
