// Run: cat snippets/source-generators/AnalyzersProjectFileGeneration.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- Analyzers ---
var v0 = findType("BovineLabs.Core.Editor.Analyzers");
if (v0 != null)
{
...
{
    sb.AppendLine("Analyzers: TYPE NOT FOUND");
    check("Analyzers exists", false);
}
