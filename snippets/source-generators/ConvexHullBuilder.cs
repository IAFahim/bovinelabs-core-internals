// Run: cat snippets/source-generators/ConvexHullBuilder.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/ConvexHullBuilder.md claims
...
// --- cone ---
var v1 = findType("BovineLabs.Core.cone");
if (v1 != null)
{
...
{
    sb.AppendLine("cone: TYPE NOT FOUND");
    check("cone exists", false);
}
