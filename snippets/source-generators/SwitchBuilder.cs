// Run: cat snippets/source-generators/SwitchBuilder.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/SwitchBuilder.md claims
...
{
    sb.AppendLine("SwitchBuilder: TYPE NOT FOUND");
    check("SwitchBuilder exists", false);
}
