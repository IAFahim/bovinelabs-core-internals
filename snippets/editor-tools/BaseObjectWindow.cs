// Run: cat snippets/editor-tools/BaseObjectWindow.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- Base ---
var v0 = findType("BovineLabs.Core.Editor.Windows.Base");
if (v0 != null)
{
...
{
    sb.AppendLine("Base: TYPE NOT FOUND");
    check("Base exists", false);
}
