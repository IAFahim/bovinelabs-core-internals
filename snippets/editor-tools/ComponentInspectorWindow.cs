// Run: cat snippets/editor-tools/ComponentInspectorWindow.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- ObjectManagement ---
var v0 = findType("BovineLabs.Core.Editor.ObjectManagement");
if (v0 != null)
{
...
// --- Editor ---
var v1 = findType("BovineLabs.Core.Extensions.Editor");
if (v1 != null)
{
...
{
    sb.AppendLine("Editor: TYPE NOT FOUND");
    check("Editor exists", false);
}
