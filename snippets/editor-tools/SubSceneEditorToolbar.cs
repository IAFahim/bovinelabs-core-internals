// Run: cat snippets/editor-tools/SubSceneEditorToolbar.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
// Verifies: docs/SubSceneEditorToolbar.md claims
...
// --- SubScenes ---
var v0 = findType("BovineLabs.Core.Editor.SubScenes");
if (v0 != null)
{
...
{
    sb.AppendLine("SubScenes: TYPE NOT FOUND");
    check("SubScenes exists", false);
}
