// Run: cat snippets/editor-tools/CoreEditorPreferencesProvider.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- EditorPreferences ---
var v0 = findType("BovineLabs.Core.Editor.EditorPreferences");
if (v0 != null)
{
...
{
    sb.AppendLine("EditorPreferences: TYPE NOT FOUND");
    check("EditorPreferences exists", false);
}
