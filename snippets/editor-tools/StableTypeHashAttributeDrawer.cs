// Run: cat snippets/editor-tools/StableTypeHashAttributeDrawer.cs | unity-cli exec --project ~/Github/bovinelabs-core-internals/BovineLabs --usings "System,System.Reflection,System.Linq"
...
// --- Inspectors ---
var v0 = findType("BovineLabs.Core.Editor.Inspectors");
if (v0 != null)
{
...
{
    sb.AppendLine("Inspectors: TYPE NOT FOUND");
    check("Inspectors exists", false);
}
